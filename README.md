...
(Fixed!! use `(net.virtualvoid.sbt.graph.Plugin.dependencyTree in Compile)` instead of just `net.virtualvoid.sbt.graph.Plugin.dependencyTree`).

see: http://stackoverflow.com/a/30190325/342235
